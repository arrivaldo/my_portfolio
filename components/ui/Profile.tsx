...
/>
    ...
    <div className="flex flex-col w-full leading-1.5">
        <div className="flex items-center space-x-2 rtl:space-x-reverse ">
            ...
            <span style={{color: 'rgb(193, 194, 211)'}} className="text-lg tinyMobile:text-[0.9rem] mobile:text-[0.9rem] tinyMobile:hidden mobile:hidden mobileBig:text-[1.05rem] font-normal">11:46</span>
        </div>
